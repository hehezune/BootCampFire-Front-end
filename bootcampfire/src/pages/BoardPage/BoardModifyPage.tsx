  ...
  return (
    <StyledPage>
      ...
      <StyledWrapperDiv>
        ...
        <StyledButtonDiv>
          <StrongBtn type="first" onClick={handlerSubmitBtn}>수정하기</StrongBtn>
          <StrongBtn type="">취소하기</StrongBtn>
          {!isDelete && <StrongBtn type="" onClick={(event) => setIsDelete(true)}>삭제하기</StrongBtn>} 
          {isDelete && <StrongBtn type="" onClick={handlerDeleteConfirmBtn}>삭제 확인</StrongBtn>}
          {isDelete && <StrongBtn type=""  onClick={(event) => setIsDelete(false)}>아니오</StrongBtn>}
        </StyledButtonDiv>
    </StyledPage>
  );
}
